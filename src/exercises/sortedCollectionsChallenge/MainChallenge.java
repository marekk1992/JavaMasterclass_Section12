...
public class MainChallenge {
    ...
    Modify the program in learning/sortedCollections package so that adding items to the shopping basket
    doesn't actually reduce the stock count but, instead, reserves the requested number of items.
